 ...
 * description:
 */
public class OnlineMovListFragment extends BaseFragment implements IOnlineView {
    ...
    private static OnlineMovListFragment btlistFragment;
    private CommonRecyclerViewAdapter mAdapter;
    private GetOnlinePresenter getOnlinePresenter;

    public static OnlineMovListFragment newInstance(String type) {
        btlistFragment = new OnlineMovListFragment();
        ...
        mRecyclerView.setOnLoadMoreListener(new TvRecyclerView.OnLoadMoreListener() {
            ...
            public boolean onLoadMore() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        getOnlinePresenter.getMovieMoreData(pageType,++index,18);
                    }
                },1000);
                return true;
            }
